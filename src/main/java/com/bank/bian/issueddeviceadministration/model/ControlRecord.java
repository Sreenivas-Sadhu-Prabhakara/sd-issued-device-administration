package com.bank.bian.issueddeviceadministration.model;
...
/**
 * The BIAN control record for this service domain: "Issued Card Administrative Plan".
 *
 ...
 * to its asset type (Issued Card). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Issued Card Administrative Plan";
